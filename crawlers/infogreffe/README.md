...
A production-ready, asynchronous web crawler for extracting data from [www.infogreffe.fr](https://www.infogreffe.fr/).
...
```python
import asyncio
from crawler import InfogreffeCrawler

async def main():
    async with InfogreffeCrawler(output_dir="data") as crawler:
