...
def crawler():
    ...
    return InfogreffeCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestInfogreffeCrawler:
    """Test suite for InfogreffeCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with InfogreffeCrawler() as crawler:
            assert crawler.session is not None
