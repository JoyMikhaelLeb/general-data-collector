...
A production-ready, asynchronous web crawler for extracting data from [wamda.com](https://wamda.com/).
...
```python
import asyncio
from crawler import WamdaCrawler

async def main():
    async with WamdaCrawler(output_dir="data") as crawler:
