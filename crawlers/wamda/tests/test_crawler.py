...
def crawler():
    ...
    return WamdaCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestWamdaCrawler:
    """Test suite for WamdaCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with WamdaCrawler() as crawler:
            assert crawler.session is not None
