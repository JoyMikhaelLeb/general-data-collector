...
def crawler():
    ...
    return WellfoundCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestWellfoundCrawler:
    """Test suite for WellfoundCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with WellfoundCrawler() as crawler:
            assert crawler.session is not None
