...
A production-ready, asynchronous web crawler for extracting data from [wellfound.com](https://wellfound.com/).
...
```python
import asyncio
from crawler import WellfoundCrawler

async def main():
    async with WellfoundCrawler(output_dir="data") as crawler:
