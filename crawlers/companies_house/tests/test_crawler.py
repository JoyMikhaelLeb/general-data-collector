"""
Tests for companies_house crawler.
"""
...
def crawler():
    ...
    return CompaniesHouseCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestCompaniesHouseCrawler:
    """Test suite for CompaniesHouseCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with CompaniesHouseCrawler() as crawler:
            assert crawler.session is not None
