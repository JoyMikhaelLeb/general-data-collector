...
from crawler import LaunchedCrawler


@pytest.fixture
def crawler():
    """Create a crawler instance for testing."""
    return LaunchedCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestLaunchedCrawler:
    """Test suite for LaunchedCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with LaunchedCrawler() as crawler:
            assert crawler.session is not None
