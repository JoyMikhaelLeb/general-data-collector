...
A production-ready, asynchronous web crawler for extracting data from [launched.io](https://launched.io/).
...
async def main():
    async with LaunchedCrawler(output_dir="data") as crawler:
