...
A production-ready, asynchronous web crawler for extracting data from [www.ventureradar.com](https://www.ventureradar.com/).
...
```python
import asyncio
from crawler import VentureradarCrawler

async def main():
    async with VentureradarCrawler(output_dir="data") as crawler:
