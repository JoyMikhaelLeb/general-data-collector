"""
Tests for ventureradar crawler.
"""
...
def crawler():
    ...
    return VentureradarCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestVentureradarCrawler:
    """Test suite for VentureradarCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with VentureradarCrawler() as crawler:
            assert crawler.session is not None
