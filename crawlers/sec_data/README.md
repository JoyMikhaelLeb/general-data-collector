...
A production-ready, asynchronous web crawler for extracting data from [data.sec.gov](https://data.sec.gov/).
...
```python
import asyncio
from crawler import SecDataCrawler

async def main():
    async with SecDataCrawler(output_dir="data") as crawler:
