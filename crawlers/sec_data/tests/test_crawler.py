...
def crawler():
    ...
    return SecDataCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestSecDataCrawler:
    """Test suite for SecDataCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with SecDataCrawler() as crawler:
            assert crawler.session is not None
