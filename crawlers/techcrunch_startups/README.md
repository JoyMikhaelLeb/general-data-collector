...
A production-ready, asynchronous web crawler for extracting data from [techcrunch.com/startups](https://techcrunch.com/startups/).
...
async def main():
    async with TechcrunchStartupsCrawler(output_dir="data") as crawler:
