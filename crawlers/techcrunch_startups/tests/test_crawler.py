"""
Tests for techcrunch_startups crawler.
"""
...
from crawler import TechcrunchStartupsCrawler


@pytest.fixture
def crawler():
    """Create a crawler instance for testing."""
    return TechcrunchStartupsCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestTechcrunchStartupsCrawler:
    """Test suite for TechcrunchStartupsCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with TechcrunchStartupsCrawler() as crawler:
            assert crawler.session is not None
