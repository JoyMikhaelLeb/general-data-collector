...
def crawler():
    ...
    return MagnittCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestMagnittCrawler:
    """Test suite for MagnittCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with MagnittCrawler() as crawler:
            assert crawler.session is not None
