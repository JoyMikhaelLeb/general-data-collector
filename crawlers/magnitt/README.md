...
A production-ready, asynchronous web crawler for extracting data from [magnitt.com](https://magnitt.com/).
...
```python
import asyncio
from crawler import MagnittCrawler

async def main():
    async with MagnittCrawler(output_dir="data") as crawler:
