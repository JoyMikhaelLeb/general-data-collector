...
def crawler():
    ...
    return BetapageCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestBetapageCrawler:
    """Test suite for BetapageCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with BetapageCrawler() as crawler:
            assert crawler.session is not None
