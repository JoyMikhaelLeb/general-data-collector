...
A production-ready, asynchronous web crawler for extracting data from [www.betapage.co](https://www.betapage.co/).
...
```python
import asyncio
from crawler import BetapageCrawler

async def main():
    async with BetapageCrawler(output_dir="data") as crawler:
