"""
opencorporates.com Web Crawler

This crawler extracts data from opencorporates.com.
...
class OpencorporatesCrawler:
    """
    Crawler for opencorporates.com.
    ...
    def parse_page(self, html: str, url: str) -> List[Dict[str, Any]]:
        ...
        # TODO: Customize parsing logic for opencorporates.com
    ...
    def save_json(self, filename: Optional[str] = None) -> Path:
        ...
        if not filename:
            ...
            filename = f"opencorporates_{timestamp}.json"
    ...
    def save_csv(self, filename: Optional[str] = None) -> Path:
        ...
        if not filename:
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            filename = f"opencorporates_{timestamp}.csv"
...
async def main():
    ...
    async with OpencorporatesCrawler(output_dir="data/opencorporates") as crawler:
        await crawler.crawl()
