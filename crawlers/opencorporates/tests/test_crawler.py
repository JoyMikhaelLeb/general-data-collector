"""
Tests for opencorporates crawler.
"""
...
from crawler import OpencorporatesCrawler


@pytest.fixture
def crawler():
    """Create a crawler instance for testing."""
    return OpencorporatesCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestOpencorporatesCrawler:
    """Test suite for OpencorporatesCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with OpencorporatesCrawler() as crawler:
            assert crawler.session is not None
