...
A production-ready, asynchronous web crawler for extracting data from [opencorporates.com](https://opencorporates.com/).
...
async def main():
    async with OpencorporatesCrawler(output_dir="data") as crawler:
