...
def crawler():
    ...
    return SecEdgarCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestSecEdgarCrawler:
    """Test suite for SecEdgarCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with SecEdgarCrawler() as crawler:
            assert crawler.session is not None
