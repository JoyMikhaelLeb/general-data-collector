...
A production-ready, asynchronous web crawler for extracting data from [www.sec.gov/edgar](https://www.sec.gov/edgar).
...
```python
import asyncio
from crawler import SecEdgarCrawler

async def main():
    async with SecEdgarCrawler(output_dir="data") as crawler:
