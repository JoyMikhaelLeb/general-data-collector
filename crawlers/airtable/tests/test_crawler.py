...
def crawler():
    ...
    return AirtableCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestAirtableCrawler:
    """Test suite for AirtableCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with AirtableCrawler() as crawler:
            assert crawler.session is not None
