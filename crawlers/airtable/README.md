...
A production-ready, asynchronous web crawler for extracting data from [airtable.com](https://airtable.com/).
...
```python
import asyncio
from crawler import AirtableCrawler

async def main():
    async with AirtableCrawler(output_dir="data") as crawler:
