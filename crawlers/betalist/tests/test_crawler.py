...
def crawler():
    ...
    return BetalistCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestBetalistCrawler:
    """Test suite for BetalistCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with BetalistCrawler() as crawler:
            assert crawler.session is not None
