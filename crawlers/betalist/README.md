...
A production-ready, asynchronous web crawler for extracting data from [betalist.com](https://betalist.com/).
...
async def main():
    async with BetalistCrawler(output_dir="data") as crawler:
