...
A production-ready, asynchronous web crawler for extracting data from [crunchbase.com](https://crunchbase.com).
...
```python
import asyncio
from crawler import CrunchbaseCrawler

async def main():
    async with CrunchbaseCrawler(output_dir="data") as crawler:
