...
def crawler():
    ...
    return CrunchbaseCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestCrunchbaseCrawler:
    """Test suite for CrunchbaseCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with CrunchbaseCrawler() as crawler:
            assert crawler.session is not None
