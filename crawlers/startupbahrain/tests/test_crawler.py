"""
Tests for startupbahrain crawler.
"""
...
def crawler():
    ...
    return StartupbahrainCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestStartupbahrainCrawler:
    """Test suite for StartupbahrainCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with StartupbahrainCrawler() as crawler:
            assert crawler.session is not None
