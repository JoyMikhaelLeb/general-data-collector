...
A production-ready, asynchronous web crawler for extracting data from [www.startupbahrain.com](https://www.startupbahrain.com/).
...
```python
import asyncio
from crawler import StartupbahrainCrawler

async def main():
    async with StartupbahrainCrawler(output_dir="data") as crawler:
