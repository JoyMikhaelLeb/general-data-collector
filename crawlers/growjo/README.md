...
A production-ready, asynchronous web crawler for extracting data from [growjo.com](https://growjo.com/).
...
```python
import asyncio
from crawler import GrowjoCrawler

async def main():
    async with GrowjoCrawler(output_dir="data") as crawler:
