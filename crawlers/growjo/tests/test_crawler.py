...
def crawler():
    ...
    return GrowjoCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestGrowjoCrawler:
    """Test suite for GrowjoCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with GrowjoCrawler() as crawler:
            assert crawler.session is not None
