...
A production-ready, asynchronous web crawler for extracting data from [www.f6s.com](https://www.f6s.com/).
...
```python
import asyncio
from crawler import F6sCrawler

async def main():
    async with F6sCrawler(output_dir="data") as crawler:
