...
def crawler():
    ...
    return F6sCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestF6sCrawler:
    """Test suite for F6sCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with F6sCrawler() as crawler:
            assert crawler.session is not None
