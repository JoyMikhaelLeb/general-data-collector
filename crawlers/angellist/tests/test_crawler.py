...
def crawler():
    ...
    return AngellistCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestAngellistCrawler:
    """Test suite for AngellistCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with AngellistCrawler() as crawler:
            assert crawler.session is not None
