...
This crawler extracts data from www.angellist.com.
...
class AngellistCrawler:
    """
    Crawler for www.angellist.com.
    ...
    BASE_URL = "https://www.angellist.com/"
    ...
    def parse_page(self, html: str, url: str) -> List[Dict[str, Any]]:
        ...
        # TODO: Customize parsing logic for www.angellist.com
    ...
    def save_json(self, filename: Optional[str] = None) -> Path:
        ...
        if not filename:
            ...
            filename = f"angellist_{timestamp}.json"
    ...
    def save_csv(self, filename: Optional[str] = None) -> Path:
        ...
        if not filename:
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            filename = f"angellist_{timestamp}.csv"
...
async def main():
    ...
    async with AngellistCrawler(output_dir="data/angellist") as crawler:
        await crawler.crawl()
