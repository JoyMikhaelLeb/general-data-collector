...
A production-ready, asynchronous web crawler for extracting data from [startupstash.com](https://startupstash.com/).
...
```python
import asyncio
from crawler import StartupstashCrawler

async def main():
    async with StartupstashCrawler(output_dir="data") as crawler:
