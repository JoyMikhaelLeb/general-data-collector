"""
Tests for startupstash crawler.
"""
...
def crawler():
    ...
    return StartupstashCrawler(output_dir="test_data", rate_limit=0.1)
...
class TestStartupstashCrawler:
    """Test suite for StartupstashCrawler."""
    ...
    async def test_context_manager(self):
        ...
        async with StartupstashCrawler() as crawler:
            assert crawler.session is not None
